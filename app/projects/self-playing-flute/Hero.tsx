...
export const Hero = () => {
  ...
  return (
    <div>
      <h1 className="text-6xl md:text-8xl">self-playing flute</h1>
      <div className="flex md:flex-row flex-col md:gap-4 max-w-lg w-9/10 md:max-w-6xl md:mt-20 mt-10 justify-between mx-auto">
        <div className="flex flex-col gap-1 items-center md:w-1/3 w-full">
          <div className="flex flex-col gap-1 text-start items-start bg-zinc-800 rounded-sm p-2 md:p-4 peer cursor-pointer transition-shadow duration-300 hover:shadow-[0_0_10px_rgba(225,225,225,0.5)]">
        ...
        <div className="flex flex-col gap-1 items-center md:w-1/3">
          <div className="flex flex-col gap-1 items-start text-start bg-zinc-800 rounded-sm p-2 md:p-4 peer cursor-pointer transition-shadow duration-300 hover:shadow-[0_0_10px_rgba(225,225,225,0.5)]">
            <h2 className="text-xl font-semibold">
              process
            </h2>
