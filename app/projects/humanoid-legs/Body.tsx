  ...
  return (
    <div className="flex flex-col gap-48 mt-40">
      <div className="flex flex-col gap-12">
        <h2 id="initial-concept" className="text-7xl font-semibold text-zinc-600">initial concept</h2>
        <Gallery items={[
          <ProcessBox
      ...
      <div className="flex flex-col gap-12">
        <h2 id="process" className="text-7xl font-semibold text-zinc-600">process</h2>
      ...
      <div className="flex flex-col gap-12 mb-30">
        <h2 id="results" className="text-7xl font-semibold text-zinc-600">results</h2>
